...
export const bookmarkTokens = (t: ThemeTokens): BookmarkTokens => ({
  label:           t.textMuted,
  containerBg:     t.dropBg,
  containerBorder: t.dropBorder,
  divider:         t.dropBorder,
  text:            t.text,
  textMuted:       t.textMuted,
  textFaint:       t.textMuted,
  iconColor:       t.textMuted,
  progressBg:      t.inputBorder,
  progressFill:    '#d4a000',
  tagBg:           t.inputBg,
  tagColor:        t.textMuted,
  deleteFaint:     t.textMuted,
  hoverBg:         t.inputBg,
});
